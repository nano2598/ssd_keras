...
# comprehensive README which might help to understand the code better. In this file I have essentially ported part of
# 'ssd7_training.ipynb' for convenience, in case you do not want to use the jupyter notebook. However this
...
# training of my final chosen model. In this file you can simply load a previously saved model instead of building
# and training from scratch, and at the end it again shows examples of detections.
